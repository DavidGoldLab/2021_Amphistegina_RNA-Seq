...
factor_labeling = read.table("./DESeq2.8203.dir/diffExpr.P0.001_C2.matrix", row.names=1)
...
background = read.table("GoSeq_List.All.txt", header=T, row.names=1)
...
go_enrich_filename = paste("./DESeq2.8203.dir/diffExpr.P0.001_C2.matrix", '.GOseq.enriched', sep='')
    ...
    go_depleted_filename = paste("./DESeq2.8203.dir/diffExpr.P0.001_C2.matrix", '.GOseq.depleted', sep='')
