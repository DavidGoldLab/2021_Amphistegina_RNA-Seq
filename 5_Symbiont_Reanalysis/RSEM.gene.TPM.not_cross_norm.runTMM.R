...
rnaseqMatrix = read.table("RSEM.gene.TPM.not_cross_norm", header=T, row.names=1, com='', check.names=F)
...
write.table(exp_study$samples, file="RSEM.gene.TPM.not_cross_norm.TMM_info.txt", quote=F, sep="\t", row.names=F)
